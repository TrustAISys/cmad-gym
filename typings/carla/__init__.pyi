...
class Actor:
	...
	is_active: bool
	"""Returns whether this object is still active in the world."""
	...
	def set_autopilot(self, enabled: bool = True, port: int = 8000):
		"""
		Sets the autopilot of a vehicle. When __True__, the vehicle will move around by itself. The autopilot takes place client-side.

		:param enabled: (bool)
		:param port: (int) The port of the TM-Server where the vehicle is to be registered or unlisted. If __None__ is passed, it will consider a TM at default port `8000`.
		"""
...
class Client:
  ...
  The client also has a recording feature that saves all the information of a simulation while running it. This allows the server to replay it at will to obtain information and experiment with it. [Here](adv_recorder.md) is some information about how to use this recorder.
	...
	def generate_opendrive_world(self, opendrive: str, parameters: OpendriveGenerationParameters = (2.0, 50.0, 1.0, 0.6, True, True, True), reset_settings: bool = True):
		"""
	...
	def load_world(self, map_name: str, reset_settings: bool = True, map_layers: MapLayer = MapLayer) -> World:
		"""
...
class WalkerBoneControlIn:
	...
	bone_transforms: list[str, Transform]
...
class Waypoint:
	...
	"""True if the current Waypoint is on an intersection as defined by OpenDRIVE."""
...
class World:
	...
	def spawn_actor(self, blueprint: ActorBlueprint, transform: Transform, attach_to: Actor = None, attachment: AttachmentType = AttachmentType.Rigid) -> Actor:
		"""
	...
	def try_spawn_actor(self, blueprint: ActorBlueprint, transform: Transform, attach_to: Actor = None, attachment: AttachmentType = AttachmentType.Rigid) -> Actor:
		"""
	...
	def get_level_bbs(self, actor_type: CityObjectLabel = Any) -> list[BoundingBox]:
		"""
	...
	def get_environment_objects(self, object_type: CityObjectLabel = Any) -> list[EnvironmentObject]:
		"""

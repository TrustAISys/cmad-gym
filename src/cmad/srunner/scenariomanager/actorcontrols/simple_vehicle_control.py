...
from cmad.srunner.scenariomanager.actorcontrols.basic_control import BasicControl
from cmad.srunner.scenariomanager.actorcontrols.visualizer import Visualizer
    ...
    def __init__(self, actor, args=None):
        ...
        if (
            ...
            self._obstacle_sensor.listen(
                lambda event: self._on_obstacle(event)

...
from cmad.srunner.autoagents.agent_wrapper import AgentWrapper
from cmad.srunner.scenariomanager.carla_data_provider import CarlaDataProvider
from cmad.srunner.scenariomanager.result_writer import ResultOutputProvider
from cmad.srunner.scenariomanager.timer import GameTime
from cmad.srunner.scenariomanager.watchdog import Watchdog
...
class ScenarioManager(object):
    ...
    def load_scenario(self, scenario, agent=None):
        ...
        if self.scenario_class is not None:
            self.scenario_class.other_actors = []

...
def is_lane_a_parking(waypoint):
    ...
    if waypoint.lane_width > 2:
        ...
        if wp_next is not None and wp_next.lane_type == carla.LaneType.Shoulder:
            ...
            if (
                wp_next_next is not None
                and wp_next_next.lane_type == carla.LaneType.Sidewalk
            ):
                return True
...
class VehicleTurningRight(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        while True:
            ...
            # Move the spawning point a bit and try again
                ...
                print(
                    " Base transform is blocking objects ", self._other_actor_transform
                )
                added_dist += 0.5
    ...
    def _create_behavior(self):
        ...
        post_timer_traverse_actor = DriveDistance(
            self.other_actors[0], 0.70 * dist_to_travel
        )

...
from cmad.srunner.scenarioconfigs.scenario_configuration import (
...
from cmad.srunner.tools.route_parser import (
    RouteParser,
    TRIGGER_THRESHOLD,
    TRIGGER_ANGLE_THRESHOLD,
)
from cmad.srunner.tools.route_manipulation import interpolate_trajectory
from cmad.srunner.tools.py_trees_port import oneshot_behavior

from cmad.srunner.scenarios.control_loss import ControlLoss
from cmad.srunner.scenarios.follow_leading_vehicle import FollowLeadingVehicle
from cmad.srunner.scenarios.object_crash_vehicle import DynamicObjectCrossing
from cmad.srunner.scenarios.object_crash_intersection import VehicleTurningRoute
from cmad.srunner.scenarios.other_leading_vehicle import OtherLeadingVehicle
from cmad.srunner.scenarios.maneuver_opposite_direction import (
    ManeuverOppositeDirection,
)
from cmad.srunner.scenarios.junction_crossing_route import (
...
class RouteScenario(BasicScenario):
    ...
    def _update_ego_vehicle(self):
        ...
        ego_vehicle = CarlaDataProvider.request_new_actor(
            "vehicle.lincoln.mkz_2017", elevate_transform, rolename="hero"
        )
    ...
    def _build_scenario_instances(
        ...
        for scenario_number, definition in enumerate(scenario_definitions):
            ...
            scenario_configuration.ego_vehicles = [
                ActorConfigurationData(
                    "vehicle.lincoln.mkz_2017", ego_vehicle.get_transform(), "hero"
                )
            ]

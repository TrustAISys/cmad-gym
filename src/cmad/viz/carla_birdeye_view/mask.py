...
from cmad.viz.carla_birdeye_view import lanes
from cmad.viz.carla_birdeye_view.lanes import LaneSide
...
def lateral_shift(transform: carla.Transform, shift: float):
...
class MapMaskGenerator:
    ...
    def __init__(self, pixels_per_meter: int, render_lanes_on_junctions: bool) -> None:

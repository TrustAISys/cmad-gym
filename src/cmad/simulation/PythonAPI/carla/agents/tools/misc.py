...
def draw_waypoints(
    world: carla.World, waypoints: List[carla.Waypoint], z: float = 0.5, life_time=1.0
):
    """
...
def is_within_distance(
    ...
    max_distance: float,
    angle_interval: Optional[Tuple[float, float]] = None,
) -> bool:
    """
...
def distance_vehicle(
    waypoint: carla.Waypoint, vehicle_transform: carla.Transform
) -> float:
    """

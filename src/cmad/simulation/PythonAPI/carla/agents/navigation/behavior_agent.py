...
class BehaviorAgent(BasicAgent):
    ...
    def __init__(
        ...
        super(BehaviorAgent, self).__init__(vehicle, target_speed, opt_dict)
    ...
    def _tailgating(self, waypoint: carla.Waypoint, vehicle_list: List[carla.Vehicle]):
        """
    ...
    def car_following_manager(
        self, vehicle: carla.Vehicle, distance: float, debug: bool = False

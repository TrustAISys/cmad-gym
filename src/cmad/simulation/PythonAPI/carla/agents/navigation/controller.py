...
class VehiclePIDController:
    ...
    def run_step(self, target_speed: float, waypoint: carla.Waypoint) -> carla.Waypoint:
        """
...
class PIDLongitudinalController:
    ...
    def _pid_control(self, target_speed: float, current_speed: float):
        """
    ...
    def change_parameters(self, K_P: float, K_I: float, K_D: float, dt: float):
...
class PIDLateralController:
    ...
    def __init__(
        ...
        Constructor method.
            ...
            :param vehicle: actor to apply to local planner logic onto
            :param offset: distance to the center line. It might cause issues if the value
    ...
    def set_offset(self, offset: float):
        """Sets a lateral offset"""
        self._offset = offset

    def _pid_control(
        self, waypoint: carla.Waypoint, vehicle_transform: carla.Transform
    ) -> float:
        """

...
class BasicAgent(object):
    ...
    def __init__(
        self, vehicle: carla.Vehicle, target_speed: float = 20, opt_dict: dict = {}
    ):
        """
    ...
    def set_destination(
        ...
        which corresponds (by default), to a location about 5 meters in front of the vehicle.
            ...
            :param start_from_vehicle (bool): whether to start the route from the vehicle current location
        """
        if not start_location:
            ...
            start_location = (
                self._vehicle.get_location() if start_from_vehicle else start_location
            )
            clean_queue = False
    ...
    def lane_change(
        self,
        direction: str,
        same_lane_time: int = 0,
        other_lane_time: int = 0,
        lane_change_time: int = 2,
    ):
        """
    ...
    def _vehicle_obstacle_detected(
        ...
        lane_offset: float = 0,
    ) -> Tuple[bool, carla.Vehicle, float]:
        """

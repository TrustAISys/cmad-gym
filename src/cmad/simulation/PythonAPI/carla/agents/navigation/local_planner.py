...
class LocalPlanner(object):
    ...
    def __init__(self, vehicle: carla.Vehicle, opt_dict: dict = {}):
        """
    ...
    def reset_vehicle(self, vehicle: carla.Vehicle = None):
        """Reset the ego-vehicle"""
        self._vehicle = vehicle
        if self._vehicle_controller:
            self._vehicle_controller._vehicle = vehicle
            self._vehicle_controller._lat_controller._vehicle = vehicle
            self._vehicle_controller._lon_controller._vehicle = vehicle
    ...
    def _compute_next_waypoints(self, k: int = 1):
        """
    ...
    def get_incoming_waypoint_and_direction(
        self, steps: int = 3
    ) -> Tuple[carla.Waypoint, RoadOption]:
        """
    ...
    def peak_second_waypoint_direction(
        self, index: int = 1
    ) -> Tuple[carla.Waypoint, RoadOption]:
        try:
            wpt, direction = self._waypoints_queue[index]
            return wpt, direction
        except IndexError as i:
            return None, RoadOption.VOID

"""
This file is ported and modified from the Pylot repository.
...
class Vector3D(object):
    ...
    def distance_to_polygon(self, polygon: Union[list, np.ndarray]) -> float:
...
class BoundingBox(object):
    ...
    def contains(self, world_point: Union[Location, np.ndarray], transform: Transform):
